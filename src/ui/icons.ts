...
export function vsFilledGearIcon(size = 16): string {
  return (
    `<svg xmlns="http://www.w3.org/2000/svg" data-filled width="${size}" height="${size}" ` +
    `viewBox="0 0 24 24" fill="currentColor"><path d="${FILLED_GEAR_PATH}"/></svg>`
  );
}
