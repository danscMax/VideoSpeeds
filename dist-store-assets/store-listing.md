...
Current version is **0.8.1** (`package.json` is the source of truth — the
...
| Store | File |
|---|---|
| Chrome Web Store | `.output/video-speeds-0.8.1-chrome.zip` |
| Firefox AMO (extension) | `.output/video-speeds-0.8.1-firefox.zip` |
| Firefox AMO (sources) | `.output/video-speeds-0.8.1-sources.zip` |
