...
Current version is **0.6.4** (`package.json` is the source of truth — the
...
| Store | File |
|---|---|
| Chrome Web Store | `.output/video-speeds-0.6.4-chrome.zip` |
| Firefox AMO (extension) | `.output/video-speeds-0.6.4-firefox.zip` |
| Firefox AMO (sources) | `.output/video-speeds-0.6.4-sources.zip` |
