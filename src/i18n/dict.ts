...
export const I18N_DICT = {
  en: {
    ...
    'welcome.title': 'Video Speed Controller is ready',
    'welcome.subtitle': 'Speed buttons, slider and hotkeys for YouTube and RuTube. A 30-second tour.',
    'welcome.card.clicks.title': 'How clicks work',
    'welcome.card.clicks.line1': 'Single click — temporary speed for the current video only.',
    'welcome.card.clicks.line2': 'Double click — save as the default speed for this site.',
    'welcome.card.clicks.line3': 'Drag the slider — same as double click: saved automatically.',
    'welcome.card.hotkeys.title': 'Keyboard shortcuts',
    'welcome.card.hotkeys.line1': 'Fine-tune by ±0.1x while watching:',
    'welcome.card.hotkeys.faster': 'speed up',
    'welcome.card.hotkeys.slower': 'slow down',
    'welcome.card.hotkeys.rebind': 'Rebindable in Settings → Keys.',
    'welcome.card.custom.title': 'Custom speeds',
    'welcome.card.custom.line1': 'Need a button for 5x or 7x? Settings → General → Speed buttons.',
    'welcome.card.custom.line2': 'Type a value (0.5–10x), press Add — appears as a pill on the panel.',
    'welcome.card.pin.title': 'Pin the icon',
    'welcome.card.pin.body': 'Keep settings one click away:',
    'welcome.card.pin.step1': 'Puzzle icon',
    'welcome.card.pin.step2': 'Find Video Speed Controller',
    'welcome.card.pin.step3': 'Pin',
    'welcome.donate.title': 'If it is useful — support the developer',
    'welcome.donate.body': 'Any tip helps and is genuinely motivating. No tracking, no nag screens.',
    'welcome.donate.cloudtips': 'Russian card · CloudTips',
    'welcome.donate.more': 'More options →',
  ...
  ru: {
    ...
    // welcome.*
    'welcome.title': 'Video Speed Controller установлен',
    'welcome.subtitle': 'Кнопки скорости, ползунок и горячие клавиши для YouTube и RuTube. Минута на знакомство.',
    'welcome.card.clicks.title': 'Как работают клики',
    'welcome.card.clicks.line1': 'Одинарный клик — временная скорость только для этого видео.',
    'welcome.card.clicks.line2': 'Двойной клик — сохранить как основную скорость для сайта.',
    'welcome.card.clicks.line3': 'Перетаскивание ползунка — то же что двойной клик: сохраняется автоматически.',
    'welcome.card.hotkeys.title': 'Горячие клавиши',
    'welcome.card.hotkeys.line1': 'Точная настройка ±0.1x во время просмотра:',
    'welcome.card.hotkeys.faster': 'ускорить',
    'welcome.card.hotkeys.slower': 'замедлить',
    'welcome.card.hotkeys.rebind': 'Можно переназначить в Настройки → Клавиши.',
    'welcome.card.custom.title': 'Свои скорости',
    'welcome.card.custom.line1': 'Нужна кнопка 5x или 7x? Настройки → Общие → Кнопки скорости.',
    'welcome.card.custom.line2': 'Введите значение (0.5–10x), нажмите Добавить — появится пилюля на панели.',
    'welcome.card.pin.title': 'Закрепите иконку',
    'welcome.card.pin.body': 'Чтобы настройки всегда были под рукой:',
    'welcome.card.pin.step1': 'Иконка-пазл',
    'welcome.card.pin.step2': 'Найдите Video Speed Controller',
    'welcome.card.pin.step3': 'Закрепить',
    'welcome.donate.title': 'Если расширение полезно — поддержите автора',
    'welcome.donate.body': 'Любая сумма приветствуется и очень мотивирует. Никакого трекинга, никаких всплывающих окон-просьб.',
    'welcome.donate.cloudtips': 'Картой РФ · CloudTips',
    'welcome.donate.more': 'Другие варианты →',
    'welcome.cta.youtube': 'Открыть YouTube',
    'welcome.cta.gotit': 'Понятно',
