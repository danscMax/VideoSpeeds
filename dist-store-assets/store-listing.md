...
Current version is **0.6.3** (`package.json` is the source of truth — the
...
| Store | File |
|---|---|
| Chrome Web Store | `.output/video-speeds-0.6.3-chrome.zip` |
| Firefox AMO (extension) | `.output/video-speeds-0.6.3-firefox.zip` |
| Firefox AMO (sources) | `.output/video-speeds-0.6.3-sources.zip` |
