...
Current version is **0.6.5** (`package.json` is the source of truth — the
...
| Store | File |
|---|---|
| Chrome Web Store | `.output/video-speeds-0.6.5-chrome.zip` |
| Firefox AMO (extension) | `.output/video-speeds-0.6.5-firefox.zip` |
| Firefox AMO (sources) | `.output/video-speeds-0.6.5-sources.zip` |
