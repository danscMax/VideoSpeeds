...
export const I18N_DICT = {
  en: {
    ...
    'panel.channel.aria_on': 'This channel has its own speed — press to clear',
    'panel.channel.aria_off': 'Save this speed for this channel',
    'panel.channel.tooltip_on': 'This channel plays at {speed}×. Press to clear it.',
    'panel.channel.tooltip_off': 'Save the current speed for this channel',
    'panel.channel.tooltip_unknown': 'The channel is not identified yet',
    'toast.channel_saved': 'Saved {speed}× for this channel',
    'toast.channel_forgotten': 'This channel no longer has its own speed',
    'toast.channel_unknown': 'The channel is not identified yet — try again in a moment',
    ...
    'diag.memory.off': 'Per-channel memory is off.',
    'diag.memory.key': 'Channel: {key}',
    'diag.memory.no_key': 'Channel: not identified',
    'diag.memory.remembered': 'saved for it: {speed}',
    'diag.memory.nothing': 'nothing yet',
    'diag.memory.global': 'default: {speed}',
    'diag.memory.playing': 'playing now: {speed}',
  ...
  ru: {
    ...
    'panel.channel.aria_on': 'У этого канала своя скорость — нажмите, чтобы снять',
    'panel.channel.aria_off': 'Сохранить эту скорость для этого канала',
    'panel.channel.tooltip_on': 'Этот канал идёт на {speed}×. Нажмите, чтобы снять.',
    'panel.channel.tooltip_off': 'Сохранить текущую скорость для этого канала',
    'panel.channel.tooltip_unknown': 'Канал пока не определён',
    'toast.channel_saved': 'Для этого канала сохранено {speed}×',
    'toast.channel_forgotten': 'У этого канала больше нет своей скорости',
    'toast.channel_unknown': 'Канал пока не определён — попробуйте через секунду',
    ...
    'diag.memory.off': 'Память по каналам выключена.',
    'diag.memory.key': 'Канал: {key}',
    'diag.memory.no_key': 'Канал: не определён',
    'diag.memory.remembered': 'для него сохранено: {speed}',
    'diag.memory.nothing': 'пока ничего',
    'diag.memory.global': 'по умолчанию: {speed}',
    'diag.memory.playing': 'сейчас играет: {speed}',
